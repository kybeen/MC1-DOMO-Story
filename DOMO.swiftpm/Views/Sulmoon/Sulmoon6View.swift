...
struct Sulmoon6View: View {
    ...
    let name = "김칫국 도모쿤♫~♪~!"
    // 대사
    @State var script = "나 도모쿤...이제 그녀에 대해 조금은 알게 되었다는... \n그녀는 공통점이 있는 사람을 좋아한다죠."
    // 배경화면
                ...
                ZStack(alignment: .top) {
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        HStack {
                            ...
                            PushView(destination: Sulmoon7View()) {
...
struct Sulmoon6View_Previews: PreviewProvider {
